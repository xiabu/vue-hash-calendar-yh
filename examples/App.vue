...
<template>
  <div class="body">
    ...
    <vue-hash-calendar :isWeekSetMonthDay="true" ref="picker" model="dialog" :is-show-arrow="false" :is-show-not-current-month-day="true" :scroll-change-date="true" :visible.sync="isShowCalendar" :default-datetime="defaultDatetime" :is-show-week-view="false" :is-show-action="true" :is-auto-change-month="true" :minute-step="1" :disabled-scroll="false" :mark-date="markDate" mark-type="dotcircle" week-start="sunday" picker-type="datetime" :show-today-button="true" :disabled-week-view="false" :change-year-fast="true" :theme-color="themeColor" format="YY/MM/DD hh:mm" lang="cn" @calendarTypeChange="calendarTypeChange" @confirm="dateConfirm" @slidechange="slidechange" @click="dateClick" @change="dateChange">
    </vue-hash-calendar>
    <!--github入口-->
    <github></github>
  </div>
